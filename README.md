...
| `xcconfig_content` | Build settings to override the project's build settings.  The input value sets xcodebuild’s `-xcconfig` option. |  | `COMPILER_INDEX_STORE_ENABLE = NO` |
